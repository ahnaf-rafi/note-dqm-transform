...
\begin{equation}
  ...
  \theta, \\
  \text{we have} \quad
  Q_{0} \left[ \bar{\rho}_{\theta, 0}^{2} \right] = o \left( |\theta|^{2}
  \right).
  \end{gathered}
...
\begin{equation*}
  \delta_{\theta, 0} = \sqrt{Q_{0} \left[ q_{\theta, 0} | T \right]} - Q_{0}
  \left[ \sqrt{q_{\theta, 0}} | T \right] \geq 0.
\end{equation*}
\(\bar{\xi}_{\theta, 0}\) is a conditional mean of \(\xi_{\theta, 0}\) and in
the following argument, the conditional variance of \(\xi_{\theta, 0}\) will
also be useful.
Denote this by
\begin{equation*}
  \sigma_{\theta, 0}^{2} (t) = Q_{0} \left[ q_{\theta, 0} \middle| T = t \right]
  - \bar{\xi}_{\theta, 0} (t)^{2} = \widetilde{p}_{\theta, 0} (t) -
  \bar{\xi}_{\theta, 0} (t)^{2}.
\end{equation*}
Note that since \(\widetilde{p}_{\theta, 0} = \left( \bar{\xi}_{\theta, 0} +
\delta_{\theta, 0} \right)^{2}\) as well, we get the relationship
\begin{equation*}
  \sigma_{\theta, 0}^{2} (t) + \bar{\xi}_{\theta, 0} (t)^{2} =
  \widetilde{p}_{\theta, 0} = \left( \bar{\xi}_{\theta, 0} +
  \delta_{\theta, 0} \right)^{2} \equiv
  \sigma_{\theta, 0}^{2} (t) = 2 \bar{\xi}_{\theta, 0} \delta_{\theta, 0} +
  \delta_{\theta, 0}^{2}.
\end{equation*}
\end{proof}
